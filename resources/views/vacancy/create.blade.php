        ...
        <div class="w3-container w3-padding-64">
          ...
          {!! Form::open(['action' => 'VacancyController@store','method' => 'POST','enctype'=>'multipart/form-data']) !!}
              <div class="w3-container w3-light-grey">
                  ...
                  {{Form::text('position','',['class'=> 'w3-input w3-border','placeholder' => 'Enter job position' ])}}
              </div><br>
              <div class="w3-container w3-light-grey">
                  {{Form::label('basic_salary','Basic salary')}}
                  {{Form::text('basic_salary','',['class'=> 'w3-input w3-border','placeholder' => 'Enter basic salary' ])}}
              </div><br>
              <div class="w3-container w3-light-grey">
                  {{Form::label('description','Job description')}}
                  {{Form::text('description','',['class'=> 'w3-input w3-border','placeholder' => 'Enter job description' ])}}
